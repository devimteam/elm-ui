...
formatMoneyInt1 : Int -> String
formatMoneyInt1 amount =
    FormatNumber.format rusLocale1 ((toFloat amount) / 100) ++ " ₽"


formatMoneyNumberOnly : Int -> String
formatMoneyNumberOnly amount =
    FormatNumber.format rusLocale1 ((toFloat amount) / 100)
